const App = (() => {
  ...
  function navigate(view) {
    ...
    switch (view) {
      ...
      case 'shared': renderShared(container); break;
  ...
  async function renderDashboard(container) {
    ...
    `;
    Search.render(document.getElementById('search-area'), (query) => FileList.render(
      document.getElementById('file-list-area'), query));
  ...
  async function renderActivity(container) {
    ...
    try {
      ...
      const actionIcons = {
        ...
        verify: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>',
        ...
        login: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>',
      };
