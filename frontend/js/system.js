          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-surface-card border border-border rounded-xl p-6">
              <h3 class="text-base font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                Encryption Engine
              </h3>
              <div class="space-y-3">
            ...
            <div class="bg-surface-card border border-border rounded-xl p-6">
              <h3 class="text-base font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            ...
            <div class="bg-surface-card border border-border rounded-xl p-6">
              <h3 class="text-base font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
                Storage
              </h3>
              <div class="space-y-3">
            ...
            <div class="bg-surface-card border border-border rounded-xl p-6">
              <h3 class="text-base font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                Security Summary
              </h3>
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between py-2">
                  ...
                  <span class="text-sm">Wrapped + RSA Encrypted</span>
                </div>
              </div>
            </div>
          </div>
